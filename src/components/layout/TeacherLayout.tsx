...
const TeacherLayout = ({ children }: TeacherLayoutProps) => {
  ...
  const navItems = [
    { path: '/teacher/library', label: 'Library', icon: 'bi-book' },
    { path: '/teacher/students', label: 'My Students', icon: 'bi-mortarboard' },
    { path: '/teacher/assignments', label: 'Assignments', icon: 'bi-clipboard-check' },
  ]
      ...
      <main style={{
        ...
        <header style={{
          ...
          <h1 style={{
            ...
            {navItems.find(item => location.pathname === item.path)?.label || 'Teacher Portal'}
          </h1>
        </header>
